...
편의를 위해 모든 level 별로 flag를 읽는 함수가 정의되어있다.
  - [[#Overview|Overview]]
	- [[#Overview#Debugging environment|Debugging environment]]
- [[#EL0, Non-secure application|EL0, Non-secure application]]
	- [[#EL0, Non-secure application#Carving an ELF binary|Carving an ELF binary]]
	- [[#EL0, Non-secure application#Exploit code (flag)|Exploit code (flag)]]
	- [[#EL0, Non-secure application#Exploit code (code execution)|Exploit code (code execution)]]
- [[#Reverse engineering BL1|Reverse engineering BL1]]
	- [[#Reverse engineering BL1#CPSR structure & gdbscript|CPSR structure & gdbscript]]
	- [[#Reverse engineering BL1#SCTLR_ELx structure|SCTLR_ELx structure]]
	- [[#Reverse engineering BL1#Identifying exception handlers|Identifying exception handlers]]
		- [[#Identifying exception handlers#VBAR_ELx structure|VBAR_ELx structure]]
		- [[#Identifying exception handlers#Exception vector structure|Exception vector structure]]
	- [[#Reverse engineering BL1#Extracting EL1, S-EL1, EL2 binaries|Extracting EL1, S-EL1, EL2 binaries]]
	- [[#Reverse engineering BL1#TCR_ELx structure & gdbscript|TCR_ELx structure & gdbscript]]
	- [[#Reverse engineering BL1#Reading a secure memory & gdbscript|Reading a secure memory & gdbscript]]
- [[#EL1, Non-secure Kernel|EL1, Non-secure Kernel]]
	- [[#EL1, Non-secure Kernel#Exploit code (flag)|Exploit code (flag)]]
	- [[#EL1, Non-secure Kernel#Gaining code execution|Gaining code execution]]
	- [[#EL1, Non-secure Kernel#Exploit code (code execution)|Exploit code (code execution)]]
- [[#EL2, Virtual machine monitor|EL2, Virtual machine monitor]]
	- [[#EL2, Virtual machine monitor#Exploit code (flag & code execution)|Exploit code (flag & code execution)]]
- [[#Exploring the Secure world|Exploring the Secure world]]
	- [[#Exploring the Secure world#Debugging the Secure world|Debugging the Secure world]]
	- [[#Exploring the Secure world#Analyzing the secure monitor|Analyzing the secure monitor]]
	- [[#Exploring the Secure world#Analyzing the Interaction Between the Normal World and the Secure World|Analyzing the Interaction Between the Normal World and the Secure World]]
		- [[#Analyzing the Interaction Between the Normal World and the Secure World#EL0 review|EL0 review]]
		- [[#Analyzing the Interaction Between the Normal World and the Secure World#EL1 review|EL1 review]]
		- [[#Analyzing the Interaction Between the Normal World and the Secure World#EL2 review|EL2 review]]
		- [[#Analyzing the Interaction Between the Normal World and the Secure World#S-EL3|S-EL3]]
		- [[#Analyzing the Interaction Between the Normal World and the Secure World#SPSR_EL3 structure & gdbscript|SPSR_EL3 structure & gdbscript]]
		- [[#Analyzing the Interaction Between the Normal World and the Secure World#AArch32 PE modes|AArch32 PE modes]]
		- [[#Analyzing the Interaction Between the Normal World and the Secure World#Diving into BL1 again|Diving into BL1 again]]
	- [[#Exploring the Secure world#Secure world pagewalk gdbscript|Secure world pagewalk gdbscript]]
	- [[#Exploring the Secure world#Reverse engineering S-EL1|Reverse engineering S-EL1]]
		- [[#Reverse engineering S-EL1#Reversing the binary loader & S-EL0 binary extraction|Reversing the binary loader & S-EL0 binary extraction]]
- [[#S-EL0, Secure application|S-EL0, Secure application]]
	- [[#S-EL0, Secure application#Exploit code (code execution & flag)|Exploit code (code execution & flag)]]
- [[#S-EL1, Secure kernel|S-EL1, Secure kernel]]
		- [[#Exploit code (code execution & flag)#Gaining code execution|Gaining code execution]]
		- [[#Exploit code (code execution & flag)#Enhancing the exploitation stability|Enhancing the exploitation stability]]
	- [[#S-EL1, Secure kernel#Exploit code (code execution & flag)|Exploit code (code execution & flag)]]
- [[#S-EL3, Secure monitor|S-EL3, Secure monitor]]
	- [[#S-EL3, Secure monitor#Exploit code (code execution & flag)|Exploit code (code execution & flag)]]
